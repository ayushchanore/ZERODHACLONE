    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-4 text-center">
          We pioneerd the discount broking model in india.<br></br> Now, we are
          breaking ground with iur technology.
        </h1>
      </div>
      <div className="row p-5 mb-5 border-top text-muted fs-6" style={{lineHeight:"1.8", fontSize:"1.2em"}}>
